...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full md:h-[calc(100vh-7rem)] h-[calc(100vh-5.5rem)]  flex items-center justify-center create-container">
      <div
      ...
      >
        ...
        <div className="w-full py-2 border-b border-gray-300 flex items-center gap-2">
          ...
          <input
            ...
            className="w-full h-full text-xl bg-transparent font-semibold outline-none
        ...
        <div className="w-full">
          <select
            name="categories"
            value={category}
            className="outline-none w-full text-base border-b border-gray-200 p-2 
          ...
          >
            ...
            {categories?.map((e) => (
              <option
                className="outline-none text-base capitalize bg-white text-headingColor"
                key={e.id}
                value={e.urlParamName}
              >
                {e.name}
              </option>
            ))}
